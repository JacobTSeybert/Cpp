...
int main(){ //begin main function
    ...
    while (count < 100) { //while loop preventing more than 10 iterations
    ...
    cout << "Time taken to run entire program: " << duration.count() << " seconds." << endl;
    return 0;
}